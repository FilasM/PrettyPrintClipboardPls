...
{
    // Original: https://github.com/mikoskinen/NSQLFormatter-dotnet
    class SQLFormatter
    {
        ...
        public static string Format(TSqlFragment source)
        {
        ...
        private class FormatProcess
        {
            ...
            private readonly IEnumerator<TSqlParserToken> tokens;
